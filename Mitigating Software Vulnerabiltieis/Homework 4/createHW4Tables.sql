...
--Updated Insert CustomerAccount
insert into CustomerAccount (account_id, user_id, CardType, ServiceCode, CardNumber, Cardholdername, expiredate,) 
values (1,1,'MasterCard','27aD','1111111111111','James Robertson','02/23/2016');

insert into CustomerAccount (account_id, user_id, CardType, ServiceCode, CardNumber, Cardholdername, expiredate) 
values (2,2,'Visa','34q4','222222222222','Test Administrator','09/16/2018');

insert into CustomerAccount (account_id, user_id, CardType, ServiceCode, CardNumber, Cardholdername, expiredate) 
values (3,3,'AMEX','48w5','333333333333','Test Customer','05/30/2019');
